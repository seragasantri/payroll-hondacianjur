            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4 sm:p-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-1">Ubah data user: <span className="font-semibold text-sky-600 dark:text-sky-400">{user.name}</span></p>
                    </div>
                    <Link
                        href={index().url}
                ...
                <div className="border-2 rounded-2xl overflow-hidden bg-white dark:bg-gray-900 shadow-xl shadow-sky-100/50 dark:shadow-none max-w-4xl mx-auto">
                    ...
                    <div className='bg-gradient-to-r from-red-500 to-red-600 dark:from-red-700 dark:to-red-800 px-6 py-4'>
                        ...
                        <p className='text-sky-50 text-sm'>Perbarui data user di bawah ini</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full border-2 border-gray-200 dark:border-gray-700 rounded-xl pl-8 pr-4 py-3 focus:outline-none focus:border-red-500 dark:focus:border-red-400 bg-white dark:bg-gray-800 transition-colors"
                        ...
                        <div className="space-y-2">
                            ...
                            <MultiSelect
                                ...
                                display="chip"
                                className="w-full [&_.p-multiselect]:border-2 border py-2 px-4 [&_.p-multiselect]:border-gray-200 [&_.p-multiselect]:dark:border-gray-700 [&_.p-multiselect]:rounded-xl [&_.p-multiselect]:focus:border-red-500"
                            />
                            {errors.roles && (
                                <p className="text-sm text-red-500 flex items-center gap-1">
                                    <svg className="size-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="bg-sky-50 dark:bg-sky-900/20 border-l-4 border-red-500 dark:border-red-400 p-4 rounded-r-xl">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-sky-800 dark:text-sky-200">Password Bersifat Opsional</p>
                                    <p className="text-xs text-sky-600 dark:text-sky-400 mt-1">Kosongkan field password jika tidak ingin mengubah password user saat ini.</p>
                                </div>
                            </div>
                        </div>

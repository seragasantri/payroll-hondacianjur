...
export default function UserEdit({ user, roles }: UserEditProps) {
    ...
    const currentRoles = user.roles?.map((role: Role) => role.name) || [];
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4 sm:p-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-1">Ubah data user: <span className="font-semibold text-orange-600 dark:text-orange-400">{user.name}</span></p>
                    </div>
                    <Link
                        href={index().url}
                ...
                <div className="border-2 rounded-2xl overflow-hidden bg-white dark:bg-gray-900 shadow-xl shadow-orange-100/50 dark:shadow-none max-w-4xl mx-auto">
                    ...
                    <div className='bg-gradient-to-r from-orange-500 to-orange-600 dark:from-orange-700 dark:to-orange-800 px-6 py-4'>
                        ...
                        <p className='text-orange-50 text-sm'>Perbarui data user di bawah ini</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full border-2 border-gray-200 dark:border-gray-700 rounded-xl pl-8 pr-4 py-3 focus:outline-none focus:border-orange-500 dark:focus:border-orange-400 bg-white dark:bg-gray-800 transition-colors"
                        ...
                        <div className="space-y-2">
                            ...
                            <MultiSelect
                                ...
                                display="chip"
                                className="w-full [&_.p-multiselect]:border-2 border py-2 px-4 [&_.p-multiselect]:border-gray-200 [&_.p-multiselect]:dark:border-gray-700 [&_.p-multiselect]:rounded-xl [&_.p-multiselect]:focus:border-orange-500"
                            />
                            {errors.roles && (
                                <p className="text-sm text-red-500 flex items-center gap-1">
                                    <svg className="size-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 dark:border-blue-400 p-4 rounded-r-xl">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-blue-800 dark:text-blue-200">Password Bersifat Opsional</p>
                                    <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">Kosongkan field password jika tidak ingin mengubah password user saat ini.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t-2 border-gray-200 dark:border-gray-800">
                            <button
                                type="submit"
                                disabled={processing}
                                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 dark:from-orange-600 dark:to-orange-500 dark:hover:from-orange-700 dark:hover:to-orange-600 disabled:from-orange-300 disabled:to-orange-400 text-white font-medium px-8 py-3 rounded-xl shadow-lg shadow-orange-500/30 dark:shadow-orange-500/20 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/40 hover:scale-105 active:scale-95"
                            >

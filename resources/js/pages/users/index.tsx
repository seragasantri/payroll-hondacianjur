                        ...
                        <tbody className='divide-y divide-gray-200 dark:divide-gray-800'>
                            {isSearching ? (
                                ...
                                users.data.map((user, index) => (
                                    <tr key={user.id} className="hover:bg-orange-50/50 dark:hover:bg-gray-800/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="flex size-11 items-center justify-center rounded-full bg-gradient-to-br from-orange-500 to-orange-600 text-white font-bold text-base shadow-md">
                                        ...
                                        <td className="px-6 py-4">
                                            <code className="rounded-lg bg-orange-100 dark:bg-orange-900/30 px-3 py-1.5 text-sm font-medium text-orange-700 dark:text-orange-400 border border-orange-200 dark:border-orange-800">
                                                @{user.username}
                                            </code>
                                        </td>
                                        <td className="px-6 py-4">
                                            {user.roles && user.roles.length > 0 ? (
                                                <div className="flex flex-wrap gap-1.5">
                                                    {user.roles.map((role, idx) => (
                                                        <span
                                                            key={idx}
                                                            className="inline-flex items-center rounded-full bg-gradient-to-r from-orange-100 to-amber-100 dark:from-orange-900/40 dark:to-amber-900/40 px-3 py-1 text-xs font-semibold text-orange-700 dark:text-orange-300 border border-orange-200 dark:border-orange-800"
                                                        >
                                                            {role.name}
                                                        </span>
                                                    ))}
                    ...
                    {users?.meta && (
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-4 bg-orange-50/50 dark:bg-gray-800/30 border-t border-gray-200 dark:border-gray-800">
                            ...
                            <div className="text-sm text-gray-600 dark:text-gray-400">
                                Menampilkan <span className='font-bold text-orange-600 dark:text-orange-400'>{users.meta.from}</span> sampai <span className='font-bold text-orange-600 dark:text-orange-400'>{users.meta.to}</span> dari <span className='font-bold text-orange-600 dark:text-orange-400'>{users.meta.total}</span> data
                            </div>

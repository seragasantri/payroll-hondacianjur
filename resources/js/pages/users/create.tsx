            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4 sm:p-6">
                ...
                <div className="border-2 rounded-2xl overflow-hidden bg-white dark:bg-gray-900 shadow-xl shadow-orange-100/50 dark:shadow-none max-w-4xl mx-auto">
                    ...
                    <div className='bg-gradient-to-r from-orange-500 to-orange-600 dark:from-orange-700 dark:to-orange-800 px-6 py-4'>
                        ...
                        <p className='text-orange-50 text-sm'>Lengkapi data user dengan benar</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <MultiSelect
                                ...
                                display="chip"
                                className="w-full [&_.p-multiselect]:border-2 [&_.p-multiselect]:border-gray-200 [&_.p-multiselect]:dark:border-gray-700 [&_.p-multiselect]:rounded-xl [&_.p-multiselect]:focus:border-orange-500"
                            />
                            {errors.roles && (
                                <p className="text-sm text-red-500 flex items-center gap-1">
                                    <svg className="size-4" fill="currentColor" viewBox="0 0 20 20">

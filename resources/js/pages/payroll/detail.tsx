...
import { ArrowLeft, Printer, Download, FileText, Calendar, User, Building, Briefcase } from 'lucide-react';
...
export default function PayrollDetail({ bulan, employees }: Props) {
...
<body>
    ...
    <div class="info">
        <div class="info-box">
            ...
            <div class="info-row"><span>Divisi:</span> <span>${employee.divisi || '-'}</span></div>

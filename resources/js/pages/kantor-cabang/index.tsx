...
export default function KantorCabangIndex({ kantorCabang }: { kantorCabang: KantorCabangList }) {
    ...
    const handleDelete = (kantorCabangId: number, kantorCabangName: string) => {
        Swal.fire({
            ...
            text: `Apakah Anda yakin ingin menghapus Cabang "${kantorCabangName}"?`,
            icon: 'warning',
            ...
            preConfirm: () => {
                return router.delete(kantorCabangDestroy(kantorCabangId).url, {
                    onSuccess: () => {
                        Swal.fire({
                            title: 'Terhapus!',
                            text: `Cabang "${kantorCabangName}" berhasil dihapus.`,
                            icon: 'success',
                            timer: 2000,
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4 sm:p-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-1">Kelola data Cabang dengan mudah</p>
                    </div>
                    ...
                    {kantorCabang?.meta && (
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-4 bg-blue-50/50 dark:bg-gray-800/30 border-t border-gray-200 dark:border-gray-800">
                            ...
                            <div className="text-sm text-gray-600 dark:text-gray-400">
                                Menampilkan <span className='font-bold text-blue-600 dark:text-blue-400'>{kantorCabang.meta.from}</span> sampai <span className='font-bold text-blue-600 dark:text-blue-400'>{kantorCabang.meta.to}</span> dari <span className='font-bold text-blue-600 dark:text-blue-400'>{kantorCabang.meta.total}</span> data
                            </div>

            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4 sm:p-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-1">Ubah data permission: <span className="font-semibold text-sky-600 dark:text-sky-400">{permission.name}</span></p>
                    </div>
                    <Link
                        href={index().url}
                ...
                <div className="border-2 rounded-2xl overflow-hidden bg-white dark:bg-gray-900 shadow-xl shadow-sky-100/50 dark:shadow-none max-w-4xl mx-auto">
                    ...
                    <div className='bg-gradient-to-r from-red-500 to-sky-500 dark:from-red-700 dark:to-sky-800 px-6 py-4'>
                        ...
                        <p className='text-sky-50 text-sm'>Perbarui data permission di bawah ini</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
                        ...
                        {/* Warning Box */}
                        <div className="bg-sky-50 dark:bg-sky-900/20 border-l-4 border-sky-500 dark:border-sky-400 p-4 rounded-r-xl">
                            <div className="flex items-start gap-3">
                                <svg className="size-5 text-sky-500 dark:text-sky-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                                </svg>
                                <div>
                                    <p className="text-sm font-medium text-sky-800 dark:text-sky-200">Peringatan</p>
                                    <p className="text-xs text-sky-600 dark:text-sky-400 mt-1">
